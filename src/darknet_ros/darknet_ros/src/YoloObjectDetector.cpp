...
void YoloObjectDetector::init()
{
  ...
  boundingMarkerPublisher_ = nodeHandle_.advertise<sensor_msgs::Image>("/bounding_box_images", 10, true);  
...
void YoloObjectDetector::publishBoundingBoxes(){
    ROS_DEBUG("[YoloObjectDetector] Publishing images with bounding boxes.");
